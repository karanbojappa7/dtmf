...
if(isset($_POST["action"]))
{
 ...
 {
  $query = "SELECT * FROM longarticle ORDER BY id DESC";
...
$article = $_POST['article'];     
  ...
  $query = "INSERT INTO longarticle(name,title,date,article) VALUES ('$file','$title','$date','$article')";
 ...
 {
  $file = addslashes(file_get_contents($_FILES["image"]["tmp_name"]));
  $query = "UPDATE longarticle SET name = '$file' WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
 ...
 {
  $query = "DELETE FROM longarticle WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
